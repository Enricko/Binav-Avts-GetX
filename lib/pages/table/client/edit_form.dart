...
import '../../../controller/table/client/client_form.dart';
import '../../../utils/custom_text_field.dart';

class EditFormClient extends StatelessWidget {
  EditFormClient({super.key, required this.idClient});
  ...
  Widget build(BuildContext context) {
    formController.getUpdatedData(idClient);
                  ...
                  onPressed: formController.isLoad.value
                      ...
                      : () async {
                          if (_formKey.currentState!.validate()) {
                            await formController.updateData(idClient).then((value) async {
                              if (value) {
