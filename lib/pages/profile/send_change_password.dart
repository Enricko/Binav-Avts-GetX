          ...
          child: Column(
            ...
            children: [
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon((controller.invisibleOldPass.value == true)
                          ...
                          : Icons.visibility_off),
                      onPressed: () {
                        controller.invisibleOldPass.value = !controller.invisibleOldPass.value;
                        // setState(() {
                        //   invisibleOldPass = !invisibleOldPass;
                        // });
                      },
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () {
                        ...
                        //   invisibleNewPass = !invisibleNewPass;
                        // });
                        controller.invisibleNewPass.value = !controller.invisibleNewPass.value;
                      },
                    ),
                    focusedBorder: const OutlineInputBorder(
                      borderSide:
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    suffixIcon: IconButton(
                      icon: Icon((controller.invisibleConfirmPass.value == true)
                          ? Icons.visibility_outlined
                          : Icons.visibility_off),
                      onPressed: () {
                        controller.invisibleConfirmPass.value = !controller.invisibleConfirmPass.value;
                        // setState(() {
                        //   invisibleConfirmPass = !invisibleConfirmPass;
                        // });
                      },
