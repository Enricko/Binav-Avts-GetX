...
class StreamSocketPipeline {
  StreamController<GetPipelineResponse> socketResponseAll = StreamController<GetPipelineResponse>();

  StreamController<GetPipelineResponse> socketResponseSingle = StreamController<GetPipelineResponse>();
  ...
  Stream<GetPipelineResponse> get getResponseSingle => socketResponseSingle.stream;
...
class PipelineService extends GetConnect {
  ...
  Future<GetPipelineResponse> getData(String token, int page, int perpage) async {
    var response = await get("${InitService.baseUrlApi}mapping?page=$page&per_page=$perpage", headers: {
